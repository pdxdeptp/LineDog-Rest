...
`manifest.json` is the machine-readable index for automation recovery. Append an entry after each completed checkpoint, migration, stale lock recovery, apply group, cross-change contract check, and final report.
