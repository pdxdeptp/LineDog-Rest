# hermes-morning-briefing Specification

## Purpose

Aggregate morning briefing sections (reminders, learning pending, sleep, weight) for Feishu delivery without markdown tables.
## Requirements
