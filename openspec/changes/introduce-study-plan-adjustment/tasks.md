...
- [x] 7.3 Write failing backend tests for applying exactly the previewed changes and rejecting unsupported/ambiguous instructions safely.
- [x] 7.4 Implement dialogue apply route, event persistence, and view refresh contract.
...
- [x] 8.3 Write failing ViewModel tests for rollover refresh, manual move cascade refresh, deadline edit, add/delete task, rest-day changes, and dialogue preview/apply state.
- [x] 8.4 Implement ViewModel adjustment state and refresh sequencing.
...
- [x] 10.3 Use Computer Use/App Use on the current checkout app path to verify rollover facts, manual move cascade, deadline red state, add/delete, rest-day behavior, and dialogue preview/apply; save evidence under Flow B.
