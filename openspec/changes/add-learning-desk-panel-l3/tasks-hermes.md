...
- [ ] 1.1 `build_pending_list` 增加 `auto_roll_days` 字段
- [ ] 1.2 单测 / smoke：`today` pending 含滚入天数

## 2. H-L4 week-load

- [ ] 2.1 新子命令 `week-load --from YYYY-MM-DD --days 28`
- [ ] 2.2 输出：`days[]` with `date`, `total_minutes`, `budget`, `over_capacity`
