...
- [x] 1.5 Add retired middle-column feature tests for cached dashboard startup: cached content remains visible with non-blocking refresh feedback when reconnecting or reopening.
...
- [x] 3.2 Keep left reminders and right controls fixed-width and the retired middle-column feature middle column adaptive.
...
- [x] 4.1 Move retired middle-column feature/dashboard state ownership to a long-lived owner if needed so panel hide/show does not cold-create the state.
- [x] 4.2 Preserve selected retired middle-column feature tab, task expansion state, drafts, and loaded dashboard data across panel hide/show.
...
- [x] 6.2 Run the relevant Swift/Xcode tests for control panel presentation and retired middle-column feature state behavior.
