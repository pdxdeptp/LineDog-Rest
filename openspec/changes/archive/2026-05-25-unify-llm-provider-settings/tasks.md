...
- [x] 1.3 Add failing persistence assertions for independent retired-feature and Smart Input provider/model/key storage.
...
- [x] 2.1 Add or generalize a provider ID and model catalog shared by retired middle-column feature and Smart Input settings.
...
- [x] 3.1 Replace duplicated retired-feature and Smart Input provider controls with a reusable LLM provider settings module.
- [x] 3.2 Add a dedicated "模型与密钥" or equivalent settings category containing retired-feature and Smart Input LLM cards.
...
- [x] 3.4 Keep feature-specific controls reachable without clutter: retired middle-column feature lazy startup and Smart Input shortcut behavior must remain available.
