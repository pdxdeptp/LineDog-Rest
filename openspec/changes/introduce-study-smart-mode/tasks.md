...
- [ ] 4.1 Write failing backend tests for morning proposal options from rolled-task lag, expected-late projects, and over-capacity days.
- [ ] 4.2 Implement structured smart proposal option generation with side-by-side candidate previews and red-state impact.
